...
Data2.Connection2.BeginTrans
With DataReport2 ' SysInfo 컨트롤이 제공하는 스크린 측정 기능을 이용하여 보고서의 크기를 맞춥니다.

        .Width = MainScreen.SysInf.WorkAreaWidth * 0.75
        .Height = MainScreen.SysInf.WorkAreaHeight * 0.95
    End With
End Sub
